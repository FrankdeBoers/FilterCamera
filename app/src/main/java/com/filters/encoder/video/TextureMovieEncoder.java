...
import com.filters.encoder.gles.EglCore;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private void handleStartRecording(EncoderConfig config) {
        ...
        result = config.mOutputFile.toString();
...
//        mVideoEncoder.drainAudioEncoder(false);
        mVideoEncoder.sendAudioToEncoder(false);
    ...
    private void handleStopRecording() {
        ...
        mVideoEncoder.sendAudioToEncoder(true);
//        mVideoEncoder.drainAudioEncoder(true);
        releaseEncoder();
